            ...
            if game_link:
                ...
                if game_name_element:
                    ...
                    if game_href:
                        ...
                        Wait_Helper.random_sleep(1,2)
                       #Todo hangi eleman kayıt edilecekse onu al ve kayıt et 
                        ...
                        categories_info=category_statistic.findAll('span',class_='MuiTypography-root MuiTypography-body1 css-19d5dex')
                        download_info=download_statistic.find('span',class_='MuiTypography-root MuiTypography-h1 BaseLink-module__link--ZB6lH AppOverviewKpiBase-module__value--cP3aS css-audbiy')
                        revenue_info=revenue_download_statistic.find('span',class_='MuiTypography-root MuiTypography-h1 BaseLink-module__link--ZB6lH AppOverviewKpiBase-module__value--cP3aS css-audbiy')
                        category_ranking_info=category_ranking.find('a',class_='MuiTypography-root MuiTypography-h1 MuiLink-root MuiLink-underlineHover BaseLink-module__link--ZB6lH AppOverviewKpiBase-module__value--cP3aS css-1blji8u')
